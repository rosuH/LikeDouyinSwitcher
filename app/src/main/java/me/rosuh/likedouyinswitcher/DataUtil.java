...
public class DataUtil {
    public static List<MediaDataBean> getVideoListData() {
        String localPath = Environment.getExternalStorageDirectory().toString() + "/Download/";
        List<MediaDataBean> videoList = new ArrayList<>();
        videoList.add(new MediaDataBean("办公室小野开番外了，居然在办公室开澡堂！老板还点赞？",
                98000,
                "http://tanzi27niu.cdsb.mobi/wps/wp-content/uploads/2017/05/2017-05-17_17-30-43.jpg",
                localPath + "1.mp4"
                ));
        videoList.add(new MediaDataBean("小野在办公室用丝袜做茶叶蛋 边上班边看《外科风云》",
                413000,
...
//                "http://tanzi27niu.cdsb.mobi/wps/wp-content/uploads/2017/05/2017-05-10_10-20-26.mp4"
        ...
        videoList.add(new MediaDataBean("花盆叫花鸡，怀念玩泥巴，过家家，捡根竹竿当打狗棒的小时候",
                439000,
...
//                "http://tanzi27niu.cdsb.mobi/wps/wp-content/uploads/2017/05/2017-05-03_13-02-41.mp4"
        ...
        videoList.add(new MediaDataBean("针织方便面，这可能是史上最不方便的方便面",
                178000,
...
//                "http://tanzi27niu.cdsb.mobi/wps/wp-content/uploads/2017/04/2017-04-28_18-20-56.mp4"
        ...
        videoList.add(new MediaDataBean("小野的下午茶，办公室不只有KPI，也有诗和远方",
                450000,
